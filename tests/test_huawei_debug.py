...
async def test_connection():
    ...
    print(f"   连接超时: {device_info['conn_timeout']}秒")
    print(f"   命令超时: {device_info['timeout']}秒")
    
    print("\n" + "=" * 70)
    print("步骤1: 测试SSH连接（详细调试）")
    print("=" * 70)
    
    connection = None
    try:
        print(f"📤 正在连接设备 {device_info['host']}...")
        print(f"📤 使用参数: {device_info}")
