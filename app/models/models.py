...
class Device(Base):
    ...
    latency = Column(Integer, nullable=True, index=True)
    last_latency_check = Column(DateTime, nullable=True, index=True)
    latency_check_enabled = Column(Boolean, nullable=False, default=True, index=True)
